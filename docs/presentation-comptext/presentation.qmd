...
## H3: Centrality vs Closure (Multiplex)
...
Table 1 shows a significant negative effect of shocks on state-dependent
elites (β ≈ -0.069, p \< 0.001), indicating a decline in their relative
participation compared to market-oriented elites. The baseline
post-shock effect is small and only marginally significant, suggesting
that shocks do not substantially alter the overall size of the elite.
...
substantially smaller in Chile (β ≈ -0.028). This pattern is consistent
with distinct regime dynamics: rupture in Mexico, recomposition in
Argentina, and continuity in Chile.
