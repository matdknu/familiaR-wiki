...
def save_to_csv(info, filename="familias_argentinas.csv"):
...
def dedup_csv(filename="familias_argentinas.csv"):
...
def main():
    url_categorias = f'{BASE_URL}/wiki/Categor%C3%ADa:Familias_de_Argentina'
    ...
    dedup_csv("familias_argentinas.csv")
